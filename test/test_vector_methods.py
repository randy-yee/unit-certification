...
{ \\ test cases for logvector
    my(v1, v2, eps = 10^(-9));
    v1 = [13.10366530 + 2.578722954 E-1020*I, \
    2.932931306 - 2.578722954 E-1020*I, \
    -14.93695740, -1.099639209 + 4.248681809*I]~;

    GP_ASSERT_VEC_NEAR(logvector(v1), [2.572891985, 1.076002369, 2.703838504, 1.479028274]~, eps);
}
...
{ \\ test cases for check_closeness
    ...
    GP_ASSERT_TRUE(check_closeness(v2,v3,0.1 ) );
