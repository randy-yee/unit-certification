...
OUTFILE1 = "data/lpohst-5-0.txt";

\\read("input/test-poly-5-0.gp");

\\INPUT_FILE = "input/extra-polynomials-5-0";
\\OUTPUT_FILE = "data/pmax-extra-";
\\INPUT_FILE = "input/test-poly-5-0.gp";
INPUT_FILE = "input/experiment-polynomials-5-0";
...
for(i=1,1,
    ...
    indexbound = 1000000;
    time_estimate = pmax_time_estimate(5,0, indexbound;)
    ...
    write(OUTFILE1, "estimated time: ",time_estimate);
